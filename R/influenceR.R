...
#'
#' The influenceR package enhances igraph by including more functions to
#' quantify the structural importance of nodes in a network. Algorithms include
#' Betweenness Centrality, Bridging, Constraint Index, Effective Network Size,
#' and Key Players. Currently, algorithms are only guaranteed to work on 
#' undirected graphs; work on directed graphs is in progress.
#' 
